...
export const Dwellers = [
  ...
  new Creature("Fire Shrimp", [5, 8], "shrimp", ["frozen shrimp", "detritus"], 0.4, 1.5, [1, 2], [24, 28], [8, 12], [8.1, 8.4], "salt", "Striking red saltwater cleaner; prefers caves and low light."),
  ...
  new Creature("Yellow Goby", [5, 8], "fish", ["brine shrimp"], 0.5, 2.5, [30, 50], [22, 26], [1, 2], [8.1, 8.4], "salt", "Bottom-dwelling saltwater fish; often lives with pistol shrimp."),
  new Creature("Multies", [3, 4], "fish", ["small pellets", "brine shrimp"], 0.4, 1.5, [15, 30], [24, 27], [15, 25], [8.0, 9.0], "fresh", "Tiny cichlid; needs high pH and plenty of empty snail shells."),
  ...
  new Creature("Diamond Goby", [10, 15], "fish", ["sand organisms", "pellets"], 0.7, 4.5, [75, 100], [22, 26], [8, 12], [8.1, 8.4], "salt", "Hard worker; sifts through sand constantly to keep it clean and white."),
...
export const Seaplants = [
  ...
  new Plant("Sea Lettuce", [5, 20], "bright-green", [7.8, 8.5], false, [15, 26], "high", [8, 12], "salt", [8, 15], [20, 40], [10, 20]),
  new Plant("Halimeda", [10, 25], "chalky-green", [8.1, 8.4], true, [22, 26], "medium", [10, 15], "salt", [2, 5], [5, 10], [15, 30]),
