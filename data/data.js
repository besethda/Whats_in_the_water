...
export const Dwellers = [
  ...
  new Creature("Panda Cory", [3, 5], "fish", ["sinking wafers"], 0.8, 5.5, [5, 10], [20, 25], [6, 12], [6.0, 7.0], "fresh", "Bottom dweller; heavy waste producer."),
  new Creature("Honey Gourami", [4, 5], "fish", ["flakes", "small insects"], 0.7, 4.0, [15, 25], [22, 28], [1, 2], [6.0, 7.5], "fresh", "Labyrinth fish; needs a larger footprint."),
  new Creature("Zebra Danio", [4, 6], "fish", ["flakes"], 0.6, 3.5, [4, 8], [18, 24], [6, 15], [6.5, 7.5], "fresh", "Fast swimmer; requires longer tanks."),
  ...
  new Creature("Clownfish", [5, 10], "fish", ["pellets", "mysis"], 0.6, 3.0, [40, 75], [23, 27], [8, 12], [8.1, 8.4], "salt", "Iconic reef fish; very hardy but territorial."),
  new Creature("Yellow Watchman Goby", [5, 8], "fish", ["brine shrimp"], 0.5, 2.5, [30, 50], [22, 26], [8, 12], [8.1, 8.4], "salt", "Bottom-dwelling saltwater fish; often lives with pistol shrimp."),
  ...
  new Creature("Royal Gramma", [5, 8], "fish", ["brine shrimp", "mysis"], 0.5, 2.5, [40, 75], [22, 26], [8, 12], [8.1, 8.4], "salt", "Cave dweller; vibrant purple and yellow. Needs rockwork to feel safe."),
  new Creature("Banggai Cardinalfish", [5, 8], "fish", ["small meaty foods"], 0.4, 2.0, [30, 50], [23, 27], [8, 12], [8.1, 8.4], "salt", "Elegant, slow-moving fish. Prefers low-flow areas and moderate lighting."),
